module AppEggShellGallery.Components.Content.AvatarRender
...
let render(children: array<ReactElement>, props: AppEggShellGallery.Components.Content.Avatar.Props, estate: AppEggShellGallery.Components.Content.Avatar.Estate, pstate: AppEggShellGallery.Components.Content.Avatar.Pstate, actions: AppEggShellGallery.Components.Content.Avatar.Actions, __componentStyles: ReactXP.LegacyStyles.RuntimeStyles) : Fable.React.ReactElement =
    ...
    AppEggShellGallery.Components.Constructors.Ui.ComponentContent(
        props = (AppEggShellGallery.Components.ComponentContent.ForFullyQualifiedName "LibClient.Components.Avatar"),
        displayName = ("Avatar"),
        samples =
                            ...
                            (
                                AppEggShellGallery.Components.ComponentSample.singleBlock AppEggShellGallery.Components.ComponentSample.Render
                                    (
                                            (castAsElementAckingKeysWarning [|
                                                @"
                <LC.Avatar rt-fs='true' Source='localImage ""/images/avatar.png""'/>
            "
                                            ...
                                            (castAsElementAckingKeysWarning [|
                                                ...
                                                AppEggShellGallery.Components.Constructors.Ui.Code(
                                                    ...
                                                    children =
                                                        [|
                                                            @"
                    <LC.Avatar rt-fs='true' theme='fun theme -> { theme with Size = 120 }' Source='localImage ""/images/avatar2.png""'/>
                "
                                                            |> makeTextNode2 __parentFQN
                                                        |]
                                                )
