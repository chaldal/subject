module AppEggShellGallery.Components.Content.Input.DecimalRender
...
let render(children: array<ReactElement>, props: AppEggShellGallery.Components.Content.Input.Decimal.Props, estate: AppEggShellGallery.Components.Content.Input.Decimal.Estate, pstate: AppEggShellGallery.Components.Content.Input.Decimal.Pstate, actions: AppEggShellGallery.Components.Content.Input.Decimal.Actions, __componentStyles: ReactXP.LegacyStyles.RuntimeStyles) : Fable.React.ReactElement =
    ...
    AppEggShellGallery.Components.Constructors.Ui.ComponentContent(
        props = (AppEggShellGallery.Components.ComponentContent.ForFullyQualifiedName "LibClient.Components.Input.Decimal"),
        ...
        samples =
                ...
                "
                                        ...
                                        visuals =
                                                (castAsElementAckingKeysWarning [|
                                                    let __parentFQN = Some "LibClient.Components.Input.Decimal"
                                                    LibClient.Components.Constructors.LC.Input.Decimal(
                                                        validity = (Valid),
                                                        onChange = (actions.OnChange "A"),
                                                        value = (estate.Values.Item "A"),
                                                        label = ("Price")
