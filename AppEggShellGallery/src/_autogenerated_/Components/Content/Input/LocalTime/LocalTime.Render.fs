module AppEggShellGallery.Components.Content.Input.LocalTimeRender
...
open AppEggShellGallery.Components.Content.Input.LocalTime



let render(children: array<ReactElement>, props: AppEggShellGallery.Components.Content.Input.LocalTime.Props, estate: AppEggShellGallery.Components.Content.Input.LocalTime.Estate, pstate: AppEggShellGallery.Components.Content.Input.LocalTime.Pstate, actions: AppEggShellGallery.Components.Content.Input.LocalTime.Actions, __componentStyles: ReactXP.LegacyStyles.RuntimeStyles) : Fable.React.ReactElement =
    ...
    AppEggShellGallery.Components.Constructors.Ui.ComponentContent(
        props = (AppEggShellGallery.Components.ComponentContent.ForFullyQualifiedName "LibClient.Components.Input.LocalTime"),
                ...
                "
                                        ...
                                        visuals =
                                                (castAsElementAckingKeysWarning [|
                                                    ...
                                                    LibClient.Components.Constructors.LC.Input.LocalTime(
                                                        validity = (Valid),
                                                        onChange = (actions.OnChange "A"),
                                                        value = (estate.Values.Item "A"),
                                                        label = ("Start Time")
