module AppEggShellGallery.Components.Content.Input.PhoneNumberRender
...
let render(children: array<ReactElement>, props: AppEggShellGallery.Components.Content.Input.PhoneNumber.Props, estate: AppEggShellGallery.Components.Content.Input.PhoneNumber.Estate, pstate: AppEggShellGallery.Components.Content.Input.PhoneNumber.Pstate, actions: AppEggShellGallery.Components.Content.Input.PhoneNumber.Actions, __componentStyles: ReactXP.LegacyStyles.RuntimeStyles) : Fable.React.ReactElement =
    ...
    AppEggShellGallery.Components.Constructors.Ui.ComponentContent(
        props = (AppEggShellGallery.Components.ComponentContent.ForFullyQualifiedName "LibClient.Components.Input.PhoneNumber"),
        ...
        samples =
                ...
                "
                                        ...
                                        visuals =
                                                (castAsElementAckingKeysWarning [|
                                                    let __parentFQN = Some "LibClient.Components.Input.PhoneNumber"
                                                    LibClient.Components.Constructors.LC.Input.PhoneNumber(
                                                        validity = (Valid),
                                                        onChange = (actions.OnChange "A"),
                                                        value = (estate.Values.Item "A"),
                                                        label = ("Home Number")
