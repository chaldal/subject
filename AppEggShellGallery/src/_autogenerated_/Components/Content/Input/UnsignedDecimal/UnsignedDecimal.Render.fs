module AppEggShellGallery.Components.Content.Input.UnsignedDecimalRender
...
open AppEggShellGallery.Components.Content.Input.UnsignedDecimal
open LibClient


let render(children: array<ReactElement>, props: AppEggShellGallery.Components.Content.Input.UnsignedDecimal.Props, estate: AppEggShellGallery.Components.Content.Input.UnsignedDecimal.Estate, pstate: AppEggShellGallery.Components.Content.Input.UnsignedDecimal.Pstate, actions: AppEggShellGallery.Components.Content.Input.UnsignedDecimal.Actions, __componentStyles: ReactXP.LegacyStyles.RuntimeStyles) : Fable.React.ReactElement =
    ...
    AppEggShellGallery.Components.Constructors.Ui.ComponentContent(
        props = (AppEggShellGallery.Components.ComponentContent.ForFullyQualifiedName "LibClient.Components.Input.UnsignedDecimal"),
        displayName = ("Input.UnsignedDecimal"),
        samples =
                ...
                "
                                        ...
                                        visuals =
                                                (castAsElementAckingKeysWarning [|
                                                    let __parentFQN = Some "LibClient.Components.Input.UnsignedDecimal"
                                                    LibClient.Components.Constructors.LC.Input.UnsignedDecimal(
                                                        validity = (Valid),
                                                        onChange = (actions.OnChange "A"),
                                                        value = (estate.Values.Item "A"),
                                                        label = ("Price")
