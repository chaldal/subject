module AppEggShellGallery.Components.Content.Input.UnsignedIntegerRender
...
open AppEggShellGallery.Components.Content.Input.UnsignedInteger
open LibClient


let render(children: array<ReactElement>, props: AppEggShellGallery.Components.Content.Input.UnsignedInteger.Props, estate: AppEggShellGallery.Components.Content.Input.UnsignedInteger.Estate, pstate: AppEggShellGallery.Components.Content.Input.UnsignedInteger.Pstate, actions: AppEggShellGallery.Components.Content.Input.UnsignedInteger.Actions, __componentStyles: ReactXP.LegacyStyles.RuntimeStyles) : Fable.React.ReactElement =
    ...
    AppEggShellGallery.Components.Constructors.Ui.ComponentContent(
        props = (AppEggShellGallery.Components.ComponentContent.ForFullyQualifiedName "LibClient.Components.Input.UnsignedInteger"),
        ...
        samples =
                ...
                "
                                        ...
                                        visuals =
                                                (castAsElementAckingKeysWarning [|
                                                    let __parentFQN = Some "LibClient.Components.Input.UnsignedInteger"
                                                    LibClient.Components.Constructors.LC.Input.UnsignedInteger(
                                                        validity = (Valid),
                                                        onChange = (actions.OnChange "A"),
                                                        value = (estate.Values.Item "A"),
                                                        label = ("Price")
                ...
                "
                    ...
                    <LC.Input.UnsignedInteger
                     Label='""Price""'
                     Value='estate.Values.Item ""A.Zero""'
                     OnChange='actions.OnChange ""A.Zero""'
                     Validity='Valid'/>
                "
                                                                |> makeTextNode2 __parentFQN
                                                            |])
                    ...
                    <LC.Input.UnsignedInteger
                     Label='""Price""'
                     Value='estate.Values.Item ""A.NegZero""'
                     OnChange='actions.OnChange ""A.NegZero""'
                     Validity='Valid'/>
                "
                                                                |> makeTextNode2 __parentFQN
                                                            |])
                    ...
                    <LC.Input.UnsignedInteger
                     Label='""Price""'
                     Value='estate.Values.Item ""A.MAX""'
                     OnChange='actions.OnChange ""A.MAX""'
                     Validity='Valid'/>
                "
                                                                |> makeTextNode2 __parentFQN
                                                            |])
                    ...
                    <LC.Input.UnsignedInteger
                     Label='""Price""'
                     Value='estate.Values.Item ""A.Overflow""'
                     OnChange='actions.OnChange ""A.Overflow""'
                     Validity='Valid'/>
                "
                                                                |> makeTextNode2 __parentFQN
                                                            |])
                    ...
                    <LC.Input.UnsignedInteger
                     Label='""Price""'
                     Value='estate.Values.Item ""A.Whitespace""'
                     OnChange='actions.OnChange ""A.Whitespace""'
                     Validity='Valid'/>
                "
                                                                |> makeTextNode2 __parentFQN
                                                            |])
