module AppEggShellGallery.Components.Route.LegacyRender
...
let render(children: array<ReactElement>, props: AppEggShellGallery.Components.Route.Legacy.Props, estate: AppEggShellGallery.Components.Route.Legacy.Estate, pstate: AppEggShellGallery.Components.Route.Legacy.Pstate, actions: AppEggShellGallery.Components.Route.Legacy.Actions, __componentStyles: ReactXP.LegacyStyles.RuntimeStyles) : Fable.React.ReactElement =
