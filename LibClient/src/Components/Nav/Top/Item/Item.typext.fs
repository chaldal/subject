module LibClient.Components.Nav.Top.Item
...
type Item(_initialProps) =
    inherit PureStatelessComponent<Props, Actions, Item>("LibClient.Components.Nav.Top.Item", _initialProps, Actions, hasStyles = true)
