...
export function render(props, estate, pstate, actions, __componentStyles) {
    ...
    return RenderResult_ToSingleElement_6E3A73D(RenderResult_ToRawElementsSingle(__parentFQN, RenderResult_Make_Z1C694E5A((__list = singleton(RenderResult_Make_2B31D457(props.children)), RenderResult_ToLeaves_410EF94B(__list)))));
}
