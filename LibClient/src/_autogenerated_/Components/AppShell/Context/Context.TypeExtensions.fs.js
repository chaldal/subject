...
import { Props } from "../../../../Components/AppShell/Context/Context.typext.fs.js";

export function LibClient_Components_TypeExtensions_TEs__TEs_MakeAppShell_ContextProps_Static_Z7C92D749(pchildren, pkey, pkeyOption) {
