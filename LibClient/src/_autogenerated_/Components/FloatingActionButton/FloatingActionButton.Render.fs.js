...
export function render(props, estate, pstate, actions, __componentStyles) {
    ...
    return RenderResult_ToSingleElement_6E3A73D(RenderResult_ToRawElementsSingle(__parentFQN, (lowLevelState = ButtonHighLevelState__get_ToLowLevel(props.State), RenderResult_Make_E25108F((tupledArg) => {
        ...
        return Make((__currExplicitProps_7 = LibClient_Components_TypeExtensions_TEs__TEs_MakePointer_StateProps_Static_76B68C13((pointerState) => {
            let __list_4, isInProgress;
            const children = (__list_4 = singleton_1((isInProgress = (lowLevelState.tag === 1), RenderResult_Make_E25108F((tupledArg_1) => {
                let __currExplicitProps, __currClass, __currStyles, __implicitProps, __list_3, onPress;
                ...
                return Make_1((__currExplicitProps = ReactXP_Components_TypeExtensions_TEs__TEs_MakeViewProps_Static_1BFB6755(), (__currClass = ((format("{0}{1}{2}{3}{4}", "view ", TopLevelBlockClass, " state-", ButtonLowLevelState__get_GetName(lowLevelState), "") + format(" {0} {1} {2}", (pointerState.IsHovered && (!pointerState.IsDepressed)) ? "is-hovered" : "", pointerState.IsDepressed ? "is-depressed" : "", (props.Label != null) ? "with-label" : "")) + nthChildClasses(__sibI_1, __sibC_1)), (__currStyles = findApplicableStyles(__mergedStyles, __currClass), (__implicitProps = toList(delay(() => append((__currClass !== "") ? singleton(["ClassName", __currClass]) : empty(), delay(() => ((!isEmpty(__currStyles)) ? singleton(["style", prepareStylesForPassingToReactXpComponent("ReactXP.Components.View", __currStyles)]) : empty()))))), injectImplicitProps(__implicitProps, __currExplicitProps))))))((__list_3 = ofArray([RenderResult_Make_E25108F((tupledArg_2) => {
                    ...
                    return Make_2((__currExplicitProps_1 = LibClient_Components_TypeExtensions_TEs__TEs_MakeIconProps_Static_Z3C9BD4B(props.Icon), (__currClass_1 = (format("{0}{1}{2}", "icon state-", ButtonLowLevelState__get_GetName(lowLevelState), "") + nthChildClasses(__sibI_2, __sibC_2)), (__currStyles_1 = findApplicableStyles(__mergedStyles, __currClass_1), (__implicitProps_1 = toList(delay(() => append((__currClass_1 !== "") ? singleton(["ClassName", __currClass_1]) : empty(), delay(() => ((!isEmpty(__currStyles_1)) ? singleton(["__style", __currStyles_1]) : empty()))))), injectImplicitProps(__implicitProps_1, __currExplicitProps_1))))))([]);
                }), Option_getOrElse(new RenderResult(0), map((label) => RenderResult_Make_410EF94B(singleton_1(RenderResult_Make_E25108F((tupledArg_3) => {
                    ...
                    return Make_1((__currExplicitProps_4 = ReactXP_Components_TypeExtensions_TEs__TEs_MakeViewProps_Static_1BFB6755(), (__currClass_4 = ("spinner-block" + nthChildClasses(__sibI_5, __sibC_5)), (__currStyles_4 = findApplicableStyles(__mergedStyles, __currClass_4), (__implicitProps_4 = toList(delay(() => append((__currClass_4 !== "") ? singleton(["ClassName", __currClass_4]) : empty(), delay(() => ((!isEmpty(__currStyles_4)) ? singleton(["style", prepareStylesForPassingToReactXpComponent("ReactXP.Components.View", __currStyles_4)]) : empty()))))), injectImplicitProps(__implicitProps_4, __currExplicitProps_4))))))((__list_2 = singleton_1(RenderResult_Make_E25108F((tupledArg_7) => {
                        ...
                        return Make_4((__currExplicitProps_5 = ReactXP_Components_TypeExtensions_TEs__TEs_MakeActivityIndicatorProps_Static_3A26C93B("#ffffff", "tiny"), (__currClass_5 = nthChildClasses(__sibI_6, __sibC_6), (__currStyles_5 = findApplicableStyles(__mergedStyles, __currClass_5), (__implicitProps_5 = toList(delay(() => append((__currClass_5 !== "") ? singleton(["ClassName", __currClass_5]) : empty(), delay(() => ((!isEmpty(__currStyles_5)) ? singleton(["style", prepareStylesForPassingToReactXpComponent("ReactXP.Components.ActivityIndicator", __currStyles_5)]) : empty()))))), injectImplicitProps(__implicitProps_5, __currExplicitProps_5))))))(empty_1());
                    })), RenderResult_ToRawElements(__parentFQN_6, __list_2)));
                }) : (new RenderResult(0)), Option_getOrElse(new RenderResult(0), map((onPress_1) => RenderResult_Make_410EF94B(singleton_1(RenderResult_Make_E25108F((tupledArg_8) => {
                    ...
                    return Make_5((__currExplicitProps_6 = LibClient_Components_TypeExtensions_TEs__TEs_MakeTapCaptureProps_Static_Z599606E6(onPress_1, void 0, void 0, void 0, void 0, pointerState), (__currClass_6 = ("tap-capture" + nthChildClasses(__sibI_7, __sibC_7)), (__currStyles_6 = findApplicableStyles(__mergedStyles, __currClass_6), (__implicitProps_6 = toList(delay(() => append((__currClass_6 !== "") ? singleton(["ClassName", __currClass_6]) : empty(), delay(() => ((!isEmpty(__currStyles_6)) ? singleton(["__style", __currStyles_6]) : empty()))))), injectImplicitProps(__implicitProps_6, __currExplicitProps_6))))))([]);
                }))), (lowLevelState.tag === 0) ? ((onPress = lowLevelState.fields[0], onPress)) : (void 0)))]), RenderResult_ToRawElements(__parentFQN_2, __list_3)));
