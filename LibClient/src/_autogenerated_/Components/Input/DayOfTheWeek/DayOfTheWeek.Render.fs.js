...
import { ofArray, ofSeq, singleton as singleton_1, isEmpty } from "../../../../../../AppSample2/src/fable_modules/fable-library.3.7.6/List.js";
...
import { days, Mode__OnPress, Mode__IsSelected_419D9A50 } from "../../../../Components/Input/DayOfTheWeek/DayOfTheWeek.typext.fs.js";
...
export function render(props, estate, pstate, actions, __componentStyles) {
    ...
    return RenderResult_ToSingleElement_6E3A73D(RenderResult_ToRawElementsSingle(__parentFQN, RenderResult_Make_E25108F((tupledArg) => {
        ...
        return Make((__currExplicitProps = ReactXP_Components_TypeExtensions_TEs__TEs_MakeViewProps_Static_1BFB6755(), (__currClass = (format("{0}{1}{2}", "view ", TopLevelBlockClass, "") + nthChildClasses(__sibI, __sibC)), (__currStyles = findApplicableStyles(__mergedStyles, __currClass), (__implicitProps = toList(delay(() => append((__currClass !== "") ? singleton(["ClassName", __currClass]) : empty(), delay(() => ((!isEmpty(__currStyles)) ? singleton(["style", prepareStylesForPassingToReactXpComponent("ReactXP.Components.View", __currStyles)]) : empty()))))), injectImplicitProps(__implicitProps, __currExplicitProps))))))((__list_12 = ofArray([(matchValue = props.Label, (matchValue == null) ? RenderResult_Make_6E3A73D((__list_5 = singleton_1(equals(props.Validity, new InputValidity(1)) ? RenderResult_Make_E25108F((tupledArg_4) => {
            ...
            return Make((__currExplicitProps_3 = ReactXP_Components_TypeExtensions_TEs__TEs_MakeViewProps_Static_1BFB6755(), (__currClass_3 = ("label invalid" + nthChildClasses(__sibI_3, __sibC_3)), (__currStyles_3 = findApplicableStyles(__mergedStyles, __currClass_3), (__implicitProps_3 = toList(delay(() => append((__currClass_3 !== "") ? singleton(["ClassName", __currClass_3]) : empty(), delay(() => ((!isEmpty(__currStyles_3)) ? singleton(["style", prepareStylesForPassingToReactXpComponent("ReactXP.Components.View", __currStyles_3)]) : empty()))))), injectImplicitProps(__implicitProps_3, __currExplicitProps_3))))))((__list_4 = singleton_1(RenderResult_Make_E25108F((tupledArg_5) => {
                ...
                let arg10_4;
                const __list_3 = singleton_1(RenderResult_Make_E25108F((tupledArg_6) => makeTextNode("Required", tupledArg_6[0], tupledArg_6[1], tupledArg_6[2])));
                arg10_4 = RenderResult_ToRawElements(__parentFQN_5, __list_3);
                return Make_1((__currExplicitProps_4 = LibClient_Components_TypeExtensions_TEs__TEs_MakeTextProps_Static_373F7BF7(), (__currClass_4 = ("label-text invalid" + nthChildClasses(__sibI_4, __sibC_4)), (__currStyles_4 = findApplicableStyles(__mergedStyles, __currClass_4), (__implicitProps_4 = toList(delay(() => append((__currClass_4 !== "") ? singleton(["ClassName", __currClass_4]) : empty(), delay(() => ((!isEmpty(__currStyles_4)) ? singleton(["__style", __currStyles_4]) : empty()))))), injectImplicitProps(__implicitProps_4, __currExplicitProps_4))))))(arg10_4);
            })), RenderResult_ToRawElements(__parentFQN_4, __list_4)));
        }) : (new RenderResult(0))), RenderResult_ToRawElements(__parentFQN_1, __list_5))) : ((label = matchValue, RenderResult_Make_6E3A73D((__list_2 = singleton_1(RenderResult_Make_E25108F((tupledArg_1) => {
            ...
            return Make((__currExplicitProps_1 = ReactXP_Components_TypeExtensions_TEs__TEs_MakeViewProps_Static_1BFB6755(), (__currClass_1 = ("label" + nthChildClasses(__sibI_1, __sibC_1)), (__currStyles_1 = findApplicableStyles(__mergedStyles, __currClass_1), (__implicitProps_1 = toList(delay(() => append((__currClass_1 !== "") ? singleton(["ClassName", __currClass_1]) : empty(), delay(() => ((!isEmpty(__currStyles_1)) ? singleton(["style", prepareStylesForPassingToReactXpComponent("ReactXP.Components.View", __currStyles_1)]) : empty()))))), injectImplicitProps(__implicitProps_1, __currExplicitProps_1))))))((__list_1 = singleton_1(RenderResult_Make_E25108F((tupledArg_2) => {
                ...
                return Make_1((__currExplicitProps_2 = LibClient_Components_TypeExtensions_TEs__TEs_MakeTextProps_Static_373F7BF7(), (__currClass_2 = (("label-text" + format(" {0}", InputValidity__get_IsInvalid(props.Validity) ? "invalid" : "")) + nthChildClasses(__sibI_2, __sibC_2)), (__currStyles_2 = findApplicableStyles(__mergedStyles, __currClass_2), (__implicitProps_2 = toList(delay(() => append((__currClass_2 !== "") ? singleton(["ClassName", __currClass_2]) : empty(), delay(() => ((!isEmpty(__currStyles_2)) ? singleton(["__style", __currStyles_2]) : empty()))))), injectImplicitProps(__implicitProps_2, __currExplicitProps_2))))))(arg10);
            })), RenderResult_ToRawElements(__parentFQN_2, __list_1)));
        })), RenderResult_ToRawElements(__parentFQN_1, __list_2)))))), RenderResult_Make_E25108F((tupledArg_7) => {
            let __currExplicitProps_5, __currClass_5, __currStyles_5, __implicitProps_5, __list_9;
            ...
            return Make_2((__currExplicitProps_5 = ReactXP_Components_TypeExtensions_TEs__TEs_MakeScrollViewProps_Static_342010B5(void 0, void 0, true), (__currClass_5 = nthChildClasses(__sibI_5, __sibC_5), (__currStyles_5 = findApplicableStyles(__mergedStyles, __currClass_5), (__implicitProps_5 = toList(delay(() => append((__currClass_5 !== "") ? singleton(["ClassName", __currClass_5]) : empty(), delay(() => ((!isEmpty(__currStyles_5)) ? singleton(["style", prepareStylesForPassingToReactXpComponent("ReactXP.Components.ScrollView", __currStyles_5)]) : empty()))))), injectImplicitProps(__implicitProps_5, __currExplicitProps_5))))))((__list_9 = singleton_1(RenderResult_Make_E25108F((tupledArg_8) => {
                ...
                return Make((__currExplicitProps_6 = ReactXP_Components_TypeExtensions_TEs__TEs_MakeViewProps_Static_1BFB6755(), (__currClass_6 = ("days" + nthChildClasses(__sibI_6, __sibC_6)), (__currStyles_6 = findApplicableStyles(__mergedStyles, __currClass_6), (__implicitProps_6 = toList(delay(() => append((__currClass_6 !== "") ? singleton(["ClassName", __currClass_6]) : empty(), delay(() => ((!isEmpty(__currStyles_6)) ? singleton(["style", prepareStylesForPassingToReactXpComponent("ReactXP.Components.View", __currStyles_6)]) : empty()))))), injectImplicitProps(__implicitProps_6, __currExplicitProps_6))))))((__list_8 = singleton_1(RenderResult_Make_410EF94B(ofSeq(map((day) => RenderResult_Make_E25108F((tupledArg_9) => {
                    ...
                    return Make((__currExplicitProps_7 = ReactXP_Components_TypeExtensions_TEs__TEs_MakeViewProps_Static_1BFB6755(), (__currClass_7 = (("day" + format(" {0}", Mode__IsSelected_419D9A50(props.Mode, day) ? "selected" : "")) + nthChildClasses(__sibI_7, __sibC_7)), (__currStyles_7 = findApplicableStyles(__mergedStyles, __currClass_7), (__implicitProps_7 = toList(delay(() => append((__currClass_7 !== "") ? singleton(["ClassName", __currClass_7]) : empty(), delay(() => ((!isEmpty(__currStyles_7)) ? singleton(["style", prepareStylesForPassingToReactXpComponent("ReactXP.Components.View", __currStyles_7)]) : empty()))))), injectImplicitProps(__implicitProps_7, __currExplicitProps_7))))))((__list_7 = ofArray([RenderResult_Make_E25108F((tupledArg_10) => {
                        ...
                        const __parentFQN_9 = "LibClient.Components.Text";
                        let arg10_8;
                        const __list_6 = singleton_1(RenderResult_Make_E25108F((text_2 = format("{0}", substring(toString(day), 0, 3)), (tupledArg_11) => makeTextNode(text_2, tupledArg_11[0], tupledArg_11[1], tupledArg_11[2]))));
                        arg10_8 = RenderResult_ToRawElements(__parentFQN_9, __list_6);
                        return Make_1((__currExplicitProps_8 = LibClient_Components_TypeExtensions_TEs__TEs_MakeTextProps_Static_373F7BF7(), (__currClass_8 = (("day-label" + format(" {0}", Mode__IsSelected_419D9A50(props.Mode, day) ? "selected" : "")) + nthChildClasses(__sibI_8, __sibC_8)), (__currStyles_8 = findApplicableStyles(__mergedStyles, __currClass_8), (__implicitProps_8 = toList(delay(() => append((__currClass_8 !== "") ? singleton(["ClassName", __currClass_8]) : empty(), delay(() => ((!isEmpty(__currStyles_8)) ? singleton(["__style", __currStyles_8]) : empty()))))), injectImplicitProps(__implicitProps_8, __currExplicitProps_8))))))(arg10_8);
                    }), RenderResult_Make_E25108F((tupledArg_12) => {
                        let __currExplicitProps_9, __currClass_9, __currStyles_9, __implicitProps_9;
                        const __sibI_9 = tupledArg_12[0] | 0;
                        const __sibC_9 = tupledArg_12[1] | 0;
                        const __pFQN_9 = tupledArg_12[2];
                        const __parentFQN_10 = "LibClient.Components.TapCapture";
                        return Make_3((__currExplicitProps_9 = LibClient_Components_TypeExtensions_TEs__TEs_MakeTapCaptureProps_Static_Z599606E6((arg10_11) => {
                            Mode__OnPress(props.Mode, day, arg10_11);
                        }), (__currClass_9 = nthChildClasses(__sibI_9, __sibC_9), (__currStyles_9 = findApplicableStyles(__mergedStyles, __currClass_9), (__implicitProps_9 = toList(delay(() => append((__currClass_9 !== "") ? singleton(["ClassName", __currClass_9]) : empty(), delay(() => ((!isEmpty(__currStyles_9)) ? singleton(["__style", __currStyles_9]) : empty()))))), injectImplicitProps(__implicitProps_9, __currExplicitProps_9))))))([]);
                    })]), RenderResult_ToRawElements(__parentFQN_8, __list_7)));
                }), days)))), RenderResult_ToRawElements(__parentFQN_7, __list_8)));
            })), RenderResult_ToRawElements(__parentFQN_6, __list_9)));
        }), Option_getOrElse(new RenderResult(0), map_1((reason) => RenderResult_Make_410EF94B(singleton_1(RenderResult_Make_E25108F((tupledArg_13) => {
            ...
            return Make((__currExplicitProps_10 = ReactXP_Components_TypeExtensions_TEs__TEs_MakeViewProps_Static_1BFB6755(), (__currClass_10 = nthChildClasses(__sibI_10, __sibC_10), (__currStyles_10 = findApplicableStyles(__mergedStyles, __currClass_10), (__implicitProps_10 = toList(delay(() => append((__currClass_10 !== "") ? singleton(["ClassName", __currClass_10]) : empty(), delay(() => ((!isEmpty(__currStyles_10)) ? singleton(["style", prepareStylesForPassingToReactXpComponent("ReactXP.Components.View", __currStyles_10)]) : empty()))))), injectImplicitProps(__implicitProps_10, __currExplicitProps_10))))))((__list_11 = singleton_1(RenderResult_Make_E25108F((tupledArg_14) => {
                ...
                let arg10_15;
                const __list_10 = singleton_1(RenderResult_Make_E25108F((text_3 = format("{0}", reason), (tupledArg_15) => makeTextNode(text_3, tupledArg_15[0], tupledArg_15[1], tupledArg_15[2]))));
                arg10_15 = RenderResult_ToRawElements(__parentFQN_12, __list_10);
                return Make_1((__currExplicitProps_11 = LibClient_Components_TypeExtensions_TEs__TEs_MakeTextProps_Static_373F7BF7(), (__currClass_11 = ("invalid-reason" + nthChildClasses(__sibI_11, __sibC_11)), (__currStyles_11 = findApplicableStyles(__mergedStyles, __currClass_11), (__implicitProps_11 = toList(delay(() => append((__currClass_11 !== "") ? singleton(["ClassName", __currClass_11]) : empty(), delay(() => ((!isEmpty(__currStyles_11)) ? singleton(["__style", __currStyles_11]) : empty()))))), injectImplicitProps(__implicitProps_11, __currExplicitProps_11))))))(arg10_15);
            })), RenderResult_ToRawElements(__parentFQN_11, __list_11)));
        }))), InputValidity__get_InvalidReason(props.Validity)))]), RenderResult_ToRawElements(__parentFQN_1, __list_12)));
    })));
}
