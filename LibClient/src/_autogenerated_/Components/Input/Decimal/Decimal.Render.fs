module LibClient.Components.Input.DecimalRender
...
let render(children: array<ReactElement>, props: LibClient.Components.Input.Decimal.Props, estate: LibClient.Components.Input.Decimal.Estate, pstate: LibClient.Components.Input.Decimal.Pstate, actions: LibClient.Components.Input.Decimal.Actions, __componentStyles: ReactXP.LegacyStyles.RuntimeStyles) : Fable.React.ReactElement =
