...
import { Props } from "../../../../Components/Input/PositiveInteger/PositiveInteger.typext.fs.js";

export function LibClient_Components_TypeExtensions_TEs__TEs_MakeInput_PositiveIntegerProps_Static_Z107E5457(pValue, pValidity, pOnChange, pRequestFocusOnMount, pLabel, pPlaceholder, pPrefix, pSuffix, pOnKeyPress, pOnEnterKeyPress, pkey, pLabelOption, pPlaceholderOption, pPrefixOption, pSuffixOption, pOnKeyPressOption, pOnEnterKeyPressOption, pkeyOption) {
