...
import { Props } from "../../../../Components/Input/UnsignedDecimal/UnsignedDecimal.typext.fs.js";

export function LibClient_Components_TypeExtensions_TEs__TEs_MakeInput_UnsignedDecimalProps_Static_770BB569(pValue, pValidity, pOnChange, pRequestFocusOnMount, pLabel, pPlaceholder, pPrefix, pSuffix, pOnKeyPress, pOnEnterKeyPress, pkey, pLabelOption, pPlaceholderOption, pPrefixOption, pSuffixOption, pOnKeyPressOption, pOnEnterKeyPressOption, pkeyOption) {
