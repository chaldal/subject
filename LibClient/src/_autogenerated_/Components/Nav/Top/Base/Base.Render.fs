module LibClient.Components.Nav.Top.BaseRender
...
let render(children: array<ReactElement>, props: LibClient.Components.Nav.Top.Base.Props, estate: LibClient.Components.Nav.Top.Base.Estate, pstate: LibClient.Components.Nav.Top.Base.Pstate, actions: LibClient.Components.Nav.Top.Base.Actions, __componentStyles: ReactXP.LegacyStyles.RuntimeStyles) : Fable.React.ReactElement =
