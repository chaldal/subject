...
import { nthChildClasses, RenderResult_ToRawElements, makeTextNode, RenderResult_Make_E25108F, RenderResult_ToRawElementsSingle, RenderResult_ToSingleElement_6E3A73D } from "../../../../../RenderResult.fs.js";
    ...
    return RenderResult_ToSingleElement_6E3A73D(RenderResult_ToRawElementsSingle(__parentFQN, RenderResult_Make_E25108F((tupledArg) => {
        ...
        return Make((__currExplicitProps_1 = LibClient_Components_TypeExtensions_TEs__TEs_MakeWith_ScreenSizeProps_Static_Z6EE84C06((screenSize) => {
            ...
            const children = (__list_1 = singleton(RenderResult_Make_E25108F((tupledArg_1) => {
                let text, __currExplicitProps, __currClass, __currStyles, __implicitProps;
                ...
                let arg10_1;
                const __list = singleton(RenderResult_Make_E25108F((text = format("{0}", props.Text), (tupledArg_2) => makeTextNode(text, tupledArg_2[0], tupledArg_2[1], tupledArg_2[2]))));
                arg10_1 = RenderResult_ToRawElements(__parentFQN_2, __list);
                return Make_1((__currExplicitProps = LibClient_Components_TypeExtensions_TEs__TEs_MakeHeadingProps_Static_DDDDD60(), (__currClass = (format("{0}{1}{2}{3}{4}", "view ", TopLevelBlockClass, " ", ScreenSize__get_Class(screenSize), "") + nthChildClasses(__sibI_1, __sibC_1)), (__currStyles = findApplicableStyles(__mergedStyles, __currClass), (__implicitProps = toList(delay(() => append((__currClass !== "") ? singleton_1(["ClassName", __currClass]) : empty(), delay(() => ((!isEmpty(__currStyles)) ? singleton_1(["__style", __currStyles]) : empty()))))), injectImplicitProps(__implicitProps, __currExplicitProps))))))(arg10_1);
