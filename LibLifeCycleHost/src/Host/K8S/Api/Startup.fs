        ...
        services
            ...
            .Configure<ForwardedHeadersOptions>(
                fun (options: ForwardedHeadersOptions) ->
                    ...
                    // BD Cluster
                    options.KnownNetworks.Add(new IPNetwork(IPAddress.Parse("103.234.164.128"), 29));
                    options.KnownNetworks.Add(new IPNetwork(IPAddress.Parse("103.147.182.96"), 29));
                    options.KnownNetworks.Add(new IPNetwork(IPAddress.Parse("103.185.176.0"), 23));
