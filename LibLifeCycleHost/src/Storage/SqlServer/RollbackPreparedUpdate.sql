CREATE OR ALTER PROCEDURE [___SCHEMA_NAME___].[___LIFECYCLE_NAME____RollbackPreparedUpdate_V2] (
    @id                         NVARCHAR(80),
...
AS
    ...
    IF @id IS NULL
        RAISERROR('___LIFECYCLE_NAME____RollbackPreparedUpdate_V2 Param id should not be NULL', 11, 1);
