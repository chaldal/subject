...
#load "../AppRenderDslCompiler/build-AppRenderDslCompiler.fsx"
#load "../LibScaffolding/build-LibScaffolding.fsx"
#load "../LibFablePlus/build-LibFablePlus.fsx"
#endif

namespace Egg.Shell.Meta.LibRtCompilerFileSystemBindings
...
module Build =
    ...
    let targetFactory =
        ...
        |> BuildFile.withExternalDependency Egg.Shell.Meta.LibFablePlus.Build.targetFactory
            (Egg.Shell.Meta.LibFablePlus.Build.Target.InitializeDependencies >=> InitializeDependencies)
        ...
        |> BuildFile.withExternalDependency Egg.Shell.Meta.LibFablePlus.Build.targetFactory
            (Egg.Shell.Meta.LibFablePlus.Build.Target.Build >=> Build)
