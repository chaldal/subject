module AppPerformancePlayground.LocalImages
...
let localImage (filename: string) : ImageSource =
    ...
    | "/images/loader.gif" ->
            ...
            ImageSource.restricted_ofWebRelativePath filename
        #else
            ImageSource.restricted_ofNativeImport (importDefault "${entryDir}/../.build/native/assets/public-dev/images/loader.gif")
        #endif
    | _ ->
