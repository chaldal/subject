...
namespace Egg.Shell.ThirdParty.ImagePicker

// Nick: I have no idea what this intellisense.fsx supposed to mean (remnants from 2021), anyways
// we don't use fake-cli anymore and just do dotnet fsi where our F# scripts use Fake as a library
