...
namespace Egg.Shell.ThirdParty.SafeAreaContext
...
module Build =
    ...
    let targetFactory =
        ...
        |> BuildFile.withDefinition (fun buildContext normalizeDir ->
            function
            | InitializeDependencies -> NodeNpm.install buildContext
